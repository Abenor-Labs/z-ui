...
Status: v0.1, early. CLI published, working. Seven components in the registry. Showcase site runs locally, not yet deployed — registry served from raw GitHub. Names/props may still change before v1.
